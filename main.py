...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset', default='MSCMR_dataset', type=str, help='multi-sequence CMR segmentation dataset')
    # set your outputdir 
    parser.add_argument('--output_dir', default='output/experiment-test/', help='path where to save, empty for no saving')
